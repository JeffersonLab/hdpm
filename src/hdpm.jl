...
if length(ARGS) == 2 && ARGS[1] == "help"
    ...
    elseif ARGS[2] == "show" hz("=")
        ...
        println("usage:   hdpm show (show version and path settings)"); hz("-")
    ...
    elseif ARGS[2] == "build" hz("=")
        ...
        println("ids:   ",join(template_ids,", ")); hz("-")
        println("usage: hdpm build [<xml-file-url> | <path>]"); hz("=")
    ...
    elseif ARGS[2] == "v-xml" hz("=")
        ...
        println("usage: hdpm v-xml [<url> | <path>]"); hz("=")
    elseif ARGS[2] == "fetch-dist" hz("=")
        ...
        println("usage: hdpm fetch-dist [<url> | <path>]"); hz("-")
